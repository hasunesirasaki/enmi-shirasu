...
%またトランザクション特有コマンドについては \ref{sig}~節を参照されたい．
...
\|\documentclass[submit,draft,noauthor]{ec2018|とすれば，
投稿用のスタイルとなる．
...
表題，著者名とその所属，および概要を前述のコマンドや環境により定義した後，\|\maketitle| によって出力する．英文表題，英文著者名，英文概要の記述は任意である．
...
に \|h| は使わない．また，図の下に見出しを，\|\caption| で指定する．文字数が多い見出しはは自動的に改
...
\tabref{tab:right} のように個々の図表と各々の \|\caption|
